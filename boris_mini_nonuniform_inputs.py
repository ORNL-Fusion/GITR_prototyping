...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 25 16:28:46 2021
...
vx += v_electrostatic * B[0]/B0
vy += v_electrostatic * B[1]/B0
vz += v_electrostatic * B[2]/B0

xxx += v_electrostatic * B[0]/B0 * t
yyy += v_electrostatic * B[1]/B0 * t
zzz += v_electrostatic * B[2]/B0 * t
